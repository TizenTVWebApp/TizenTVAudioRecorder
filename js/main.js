(function () {
        ...
        document.addEventListener('keydown', function (e) {
            ...
            switch (e.keyCode) {
                ...
                case 49: // Key 1
                    ...
                    break;
                case 50: // Key 2
                	var url = "http://192.168.1.100:9090";
                	var config = {};
                    stopRecordandUpload(url, config);
                    break;
                case 51: // Key 3
                	var folder = 'test';
                	var filename = 'SOUND_' + Date.now().toString() + '.wav';;
                	stopRecordandSaveToLocal(folder, filename);
                    break;
                case 10009: // Return
    ...
    window.onload = function () {
        ...
        var index = sharedDir.split("shared");
        var absoluteDir = index[0].replace('file://','')+'res/wgt/';
        console.log("absoluteDir directory : " + absoluteDir);
